...
FDK_DATASERVICE_HARVESTER_URL = os.getenv('FDK_DATASERVICE_HARVESTER',
...
async def test_catalog(cli, mock_aio_response):
...
@pytest.mark.integration
async def test_not_ready(cli) -> None:
